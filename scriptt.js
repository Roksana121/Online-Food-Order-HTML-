$(document).ready(function() {
    ...
    $("#newIngredient").attr("placeholder", "separate ingredients with a comma");
        ...
        for (var i = 0; i < newIngredient.length; i++){
         $(this).parent().siblings("ul").append("<li>" + newCheckbox + newIngredient[i] + "  (+BDT.3)</li>");
        }
    ...
    $(".listOver").on("click", function () {
        ...
        var orderPrice = '<h3 class="orderPrice"><span>' + $(this).parent().children(".totalDialog").children("span").text() + '</span>BDT. <h3>'
        ...
        $("#listOfOrders").children("li").children(".orderPrice").children("span").each(function () {
            ...
            $(".cart > h3 > span").text(totalOrderPrice + "BDT. ");
        });
